...
extern struct rddma_event *new_rddma_event(struct rddma_events *, struct rddma_desc_param *, struct rddma_bind *, int);
...
extern struct rddma_event *rddma_event_create(struct rddma_events *, struct rddma_desc_param *, struct rddma_bind *, int);
